...
```{r Auto-correlation, out.width='60%', out.height='60%'}
...
smoothing the curve to much. Choosing a kernel size of 30 or 60 
seamed to be appropriate. 
Smoothing the entire series and looking at the line plot for the smoothed 
series, showed that a kernel size of 7 or higher also filtered 
away the negative values.
When performing the principal component analysis, the variance explained by
the first component decreased some, but the differences between the countries
became smaller, except for India.

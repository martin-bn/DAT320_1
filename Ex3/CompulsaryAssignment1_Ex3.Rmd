...
univariate time series with only one variable that is varying over. The time domain is selected to be from 16.03.2020 to 01.01.2022. 
...
for the measurement of new cases. However, since Sweden did not test for covid every day, the series for this 
country contains many values that are 0. Denmark, Great Britain and India have some entries that are below 0. This can be seen from the minimum value in the summary statistics and also in the line plot.
